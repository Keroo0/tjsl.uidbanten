          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/30">
                ...
                <TableHead className="font-semibold hidden sm:table-cell">Tahun</TableHead>
                <TableHead className="font-semibold hidden sm:table-cell">Kategori</TableHead>
            ...
            <TableBody>
              {programs.map((p) => (
                <TableRow key={p.id} className="hover:bg-muted/20">
                  ...
                  <TableCell className="text-sm hidden sm:table-cell">{p.year}</TableCell>
                  <TableCell className="text-sm text-muted-foreground hidden sm:table-cell">{CATEGORY_LABELS[p.category]}</TableCell>
                  <TableCell>
